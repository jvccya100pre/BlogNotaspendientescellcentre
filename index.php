...
// Campaign Routes
$router->add('GET', '/campaigns', 'CampaignController@index');
$router->add('GET', '/campaigns/create', 'CampaignController@showCreate');
$router->add('GET', '/campaigns/edit', 'CampaignController@showEdit');
$router->add('POST', '/campaigns/save', 'CampaignController@save');
$router->add('GET', '/campaigns/delete', 'CampaignController@delete');
$router->add('GET', '/api/campaigns/items', 'CampaignController@getItems');
