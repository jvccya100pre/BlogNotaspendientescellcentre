        ...
        <div>
            ...
            <p style="font-size:0.9rem; color:rgba(255,255,255,0.6);">
                <?php if ($identificador_unico): ?>
                    Modificando registro: <strong
                        style="color:var(--highlight-color);"><?php echo $identificador_unico; ?></strong>
                <?php else: ?>
        ...
        <div class="form-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
            ...
            <div class="form-group" style="grid-column: span 1;">
                ...
                <input class="form-control" type="text" id="telefono" name="telefono" value="<?php echo $telefono; ?>"
                    required placeholder="Ej: +584123456789">
            ...
            <div class="form-group"
                style="grid-column: span 2; display:grid; grid-template-columns: 1fr 1fr 1fr; gap: 1rem;">
                <div>
                ...
                <div>
                    ...
                    <select id="municipio_id" name="municipio_id" <?php echo empty($municipiosList) ? 'disabled' : ''; ?>>
                        <option value="">-- Seleccionar --</option>
                ...
                <div>
                    ...
                    <select id="ciudad_id" name="ciudad_id" <?php echo empty($ciudadesList) ? 'disabled' : ''; ?>>
                        <option value="">-- Seleccionar --</option>
            ...
            <div class="form-group" style="grid-column: span 2;">
                ...
                <textarea class="form-control" id="direccion" name="direccion" required
                    placeholder="Dirección detallada de domicilio o entrega"><?php echo $direccion; ?></textarea>
            ...
            <div class="form-group"
                style="grid-column: span 2; display:grid; grid-template-columns: 1fr 1fr 100px; gap: 1rem;">
                <div>
                ...
                <div>
                    ...
                    <input class="form-control" type="number" id="cantidad_items" name="cantidad_items"
                        value="<?php echo isset($client) ? htmlspecialchars($client->cantidad_items) : 1; ?>" min="1"
                        required style="padding: 0.75rem 1rem;">
                </div>
            </div>
            ...
            <div class="form-group" style="grid-column: span 1;">
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:1rem;">
                    <div>
                        <label class="form-label" for="lapso_dias">Llamar Fecha *</label>
                        <input class="form-control" type="date" id="lapso_dias" name="lapso_dias"
                            value="<?php echo !empty($lapso_dias) ? $lapso_dias : date('Y-m-d'); ?>" required
                    ...
                    <div>
                        <label class="form-label" for="lapso_tiempo">Llamar Hora *</label>
                        <input class="form-control" type="time" id="lapso_tiempo" name="lapso_tiempo"
                            value="<?php echo !empty($lapso_tiempo) ? $lapso_tiempo : date('H:i'); ?>" required
                            style="padding: 0.65rem 1rem;">
            ...
            <div class="form-group" style="grid-column: span 2;">
                ...
                <input class="form-control" type="file" id="archivo_adjunto" name="archivo_adjunto" <?php echo empty($archivo_adjunto) ? '' : ''; ?> accept="image/*,application/pdf,application/zip">
                <?php if ($archivo_adjunto): ?>
                    <div style="margin-top: 0.5rem; font-size: 0.85rem;">
                        <span>Archivo actual: </span>
                        <a href="<?php echo $archivo_adjunto; ?>" target="_blank"
                            style="color: var(--highlight-color); text-decoration: underline; font-weight: 500;"><?php echo basename($archivo_adjunto); ?></a>
                    </div>
                <?php endif; ?>
            ...
            <div class="form-group" style="grid-column: span 2; margin-bottom: 2rem;">
                ...
                <textarea class="form-control" id="observacion" name="observacion" required
                    placeholder="Escriba los detalles y observaciones obligatorias sobre la llamada..."><?php echo $observacion; ?></textarea>
