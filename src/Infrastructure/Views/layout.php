...
<body>
    ...
    <nav class="navbar">
        ...
        <?php if (isset($_SESSION['user'])): ?>
            <div class="navbar-user">
                ...
                <a href="logout" class="btn btn-secondary btn-danger action-btn" style="padding: 0.35rem 0.8rem; font-size: 0.85rem;">Salir</a>
            </div>
        <?php endif; ?>
    </nav>
    ...
    <?php if (isset($_SESSION['user'])): ?>
        <div id="inactivityModal" class="modal-overlay" style="display:none; position:fixed; top:0; left:0; width:100%; height:100%; background:rgba(0,0,0,0.85); z-index:9999; justify-content:center; align-items:center; backdrop-filter:blur(10px);">
            <div class="glass-card" style="max-width:400px; text-align:center; padding:2.5rem; border:1px solid var(--highlight-color); border-radius:16px;">
                <svg style="width:64px;height:64px;fill:var(--highlight-color);margin-bottom:1rem;display:inline-block;" viewBox="0 0 24 24">
                ...
                <p style="margin-bottom:1.5rem; font-size:0.95rem; color:rgba(255,255,255,0.8); line-height:1.5;">Su sesión está a punto de cerrarse por inactividad. Se cerrará automáticamente en <strong id="inactivityTimer" style="color:var(--highlight-color); font-size:1.1rem;">60</strong> segundos.</p>
                <button id="extendSessionBtn" class="btn btn-highlight" style="width:100%;">Extender Inicio de Sesión</button>
            </div>
        </div>
